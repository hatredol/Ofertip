		              	...
		              	<div class="col-md-12">
							...
							<div class="tab-content">
							  <div class="tab-pane active" id="ofertas">
								  ...
								  <div class="tab-pane" id="suscritos">
								  	<h4>En este apartado encontrara reportes referidos a suscriptores</h4>
								  		<div class="row">
										<div class="col-md-8">
											<!-- BEGIN PORTLET-->   
											<div class="portlet box blue" style="padding:0 0 10px 0; border: 1px solid #b4cef8;">
								  ...
								  <div class="tab-pane" id="codigos">
								  	<h4>En este apartado encontrara reportes referidos a sus codigos de ofertas</h4>
								  	<div class="row">
									<div class="col-md-8">
										<!-- BEGIN PORTLET-->   
										<div class="portlet box blue" style="padding:0 0 10px 0; border: 1px solid #b4cef8;">
									...
									<div class="col-md-4">
										...
										<div class="portlet box blue" style="padding:0 0 10px 0; border: 1px solid #b4cef8;">
											<div class="portlet-title text-center">
												<div id="cap-todasofertas"><i class="fa fa-reorder"></i> Todos los Codigos de Promocion</div>
												<h4>Reporte de todos los codigos de promocion</h4>
											</div>
											<div class="portlet-body form text-center">
												<!-- BEGIN FORM-->
												<button type="submit" class="btn green"><i class="fa fa-check"></i> Ver Reporte</button>
